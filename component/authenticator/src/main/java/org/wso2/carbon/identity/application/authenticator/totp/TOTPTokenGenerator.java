...
public class TOTPTokenGenerator {
     ...
     * @throws TOTPException When could not find user realm for the given tenant domain, invalid secret key, decrypting
     * invalid key and could not find the configured hashing algorithm
     */
    public static String generateTOTPTokenLocal(String username, AuthenticationContext context) throws TOTPException {
        long token = 0;
        ...
        if (username != null) {
            try {
                ...
                if (userRealm != null) {
                    ...
                    String firstName = userRealm.getUserStoreManager().getUserClaimValue
                            (tenantAwareUsername,TOTPAuthenticatorConstants.FIRST_NAME_CLAIM_URL, null);
     ...
     */
    private static void sendNotification(String tenantAwareUsername, String firstName, String token, String email)
